        ...
        <div className="flex items-center justify-center min-h-screen">
            ...
            <h1 className='text-2xl text-center mb-3'>Sign up</h1>
                ...
                <form>
                    ...
                    <button type="submit" onClick={onSignUp} className="w-full mt-6 bg-[#081B29] hover:bg-[#050E15] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Sign up</button>
                    <p className="text-md text-gray-700 mt-4">Already have an account? <Link to='/login' className='text-blue-500'>Sign in</Link></p>
